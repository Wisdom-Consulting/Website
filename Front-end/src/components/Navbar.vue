...
<template>
  <Suspense>
              ...
              <MenuItems
                ...
                <MenuItem v-slot="{ active }">
                  <RouterLink to="/profile"
                              :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">My Profile
                  </RouterLink>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                  <RouterLink to="#" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">
                    Settings
                  </RouterLink>
                </MenuItem>
                <MenuItem v-slot="{ active }">
    ...
    <template #fallback>
      <div>
        ........LOOOOOOOOOOOOOOOOOOOOOOOOOOOODING.............
      </div>
    </template>
  </Suspense>
